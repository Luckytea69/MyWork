...
//+------------------------------------------------------------------+
#property copyright "Copyright 2024, Gorem";
#property link "";
#property version "";
#property strict
...
enum ETipoAdattamentoChiusura
  {
   ENonAdattare = 0, // Don't Adapt
   EAdattaSuSizeBasa = 1, // Fits on size basis (on 0.01 basis)
   EAdattaSuSommatoriaSize = 2 // Fits on total size
  };

enum ETipoChiusuraOverlayContrario
  {
   EPositiva = 0, // Positive
   ENegativa = 1, // Negative
   EPositivaONegativa = 2 // Positive & Negative
  };

enum ETipoControlloFlottante
  {
   EValutaConto = 0, // In Account Currency
   EPercentualeSuBalance = 1 // Percentage On Balance
  };

enum ETipoPiramidazione
  {
   EPiramidazioneNessuna = 0, // Disabled
   EPiramidazionePoints = 1, // In Points
   EPiramidazioneIngressoSuccessivo = 2 // Next entrance
  };

enum ETipoIncrementoSize
  {
   ENessuno = 0, // Nobody
   EMoltiplicatore = 1, // Multiplier
   EAddizionale = 2 // Additional
  };
...
extern string commentoAggiuntivo; // Additional Comment (not use : and ;)
extern int numeroMassimoCoppieOperative = 20; // Maximum number of operating pairs
extern string strumenti = "EURUSD,GBPUSD,GBPCAD,USDCAD,EURGBP,EURAUD,AUDUSD,AUDCAD,USDJPY"; // Instruments
extern string suffisso; // Suffix
extern int periodoCorrelazione = 50; // Period Correlation
extern int periodoMediaCorrelazione = 50; // Period Mean Correlation
extern string eaOverlay = "------------------ Overlay Settings -------------------"; // <>
extern int numeroBarreOverlay = 900; // Number of Bars
extern bool calcolaDistanzaDaUltimoIncrocio; // Calculate distance from last intersection
extern string eaIndicatoreSpreadRatio = "-------------- Spread Ratio settings --------------"; // <>
extern bool utilizzaSpreadRatio; // Use spread ratio
extern string ea; // <--- Bollinger Settings --->
extern int periodoBollinger = 40; // Bollinger period
extern double deviazioneStandard = 1; // Standard deviation
extern string eaOper = "------------------ Operational Settings -------------------"; // <>
extern string orarioOperativita = "00:00:00-23:59:59"; // Operating Time (Broker)
extern string orarioOperativita2 = "00:00:00-23:59:59"; // Operation Hour 2 (Broker)
extern bool entraSubito; // Enter immediately as soon as you place or update. input parameters
extern double lottiBase = 0.1; // Basic Lots
extern bool calcolaLottiAutomaticamente = true; // Calculate batches automatically (for the second instrument)
extern double valoreOverlayPerIngresso = 90; // Overlay value per input
extern double valorePuntiOverlayPerIngresso; // Overlay Points Value Per Entry
extern bool utilizzaFiltroCorrelazionePerIngresso; // Use Correlation Filter per input
extern double valoreCorrelazionePositivaPerIngesso = 60; // Positive correlation value per input
extern double valoreCorrelazioneNegativaPerIngesso; // Negative correlation value per entry
extern string eaSLTP = "------------------------- TP & SL settings -------------------------"; // <>
extern ETipoAdattamentoChiusura tipoAdattamentoSize = ENonAdattare; // Select the type of closing value adaptation
extern double percentualeSizePerAdattamento1 = 100; // % Size adaptation (by summation)
extern double targetValuta = 10; // Target Currency, 0 is disabled
extern int numeroMediazioniAttivazioneSecondoTarget; // Number of Mediations Activation According to Target, 0 is inactive.
extern double percentualeSizePerAdattamento2 = 100; // % Size adaptation (by summation)
extern double targetValuta2 = 10; // Target Currency 2
extern int numeroMediazioniAttivazioneTerzoTarget; // Number of Mediations Activation of Third Target, 0 is inactive.
extern double percentualeSizePerAdattamento3 = 100; // % Size adaptation (by summation)
extern double targetValuta3 = 10; // Target Currency 3
extern double stopValuta; // Stoploss Evaluate, 0 is disabled
extern double trailingStopStart; // Trailing Stop Start, 0 is disabled
extern double trailingStop; // Trailing Stop
extern double trailingStep; // Trailing Step
extern bool utilizzaChiusuraSuValoreOverlay; // Use close on overlay value
extern double valoreOverlayPerChiusura = 60; // Overlay value for closing
extern ETipoChiusuraOverlayContrario tipoChiusuraOverlay = EPositivaONegativa; // Select the type of closure
extern int numeroMassimoOperazioniInGain; // Maximum number of gain operations
extern double massimoGainGiornaliero; // Maximum Gain Daily in currency, 0 is disabled
extern double massimoLossGiornaliero; // Maximum Daily Loss in currency, 0 is disabled
extern bool limitaIngressoNuoveOperazioniSeSuperatoDD; // Limit Entry of New Transactions If DD Exceeded
extern bool limitaIngressoGridOperazioniSeSuperatoDD; // Limit Entry Grid Operations If DD Exceeded
extern int numeroMassimoOrdiniPerValuta; // Maximum number of orders per currency, 0 is unlimited
extern int numeroMassimoOrdiniPerStrumentoFinanziario; // Maximum number of orders per Financial Instrument, 0 is unlimited
extern ETipoControlloFlottante tipoControlloFlottante = EValutaConto; // Select the floating control type
extern double valoreLimite; // Limit value
extern string eaPir = "------------------------- Pyramiding Settings -------------------------"; // <>
extern ETipoPiramidazione tipoPiramidazione1 = EPiramidazioneNessuna; // Select the type of Pyramidation
extern int numeroMassimoPiramidazioni; // Maximum number of operations, 0 is unlimited
extern bool misuraDistanzaAncheSuSecondoStrumento; // Measure distance also on second instrument
extern int pointsDistanzaPiramidazione; // Points Pyramidation distance Step 1 (from first tool)
extern bool utilizzaPiramidazioneIndipendente; // Use independent pyramiding
extern int numeroOperazioniDifferenzialePerDisattivarePirIndipendente; // Differential Number of Operations to Deactivate Piram. Independent
extern bool disattivaPiramidazioneIndipendenteSeValuteUguali; // Disable Piram. Independent if equal numerator/denom pairs
extern ETipoPiramidazione tipoPiramidazione2 = EPiramidazioneNessuna; // Select the type of Pyramidation
extern int numeroPiramidazioneStep2; // Number of Pyramidations for Step 2
extern int pointsDistanzaPiramidazioneStep2; // Points Distance pyramiding Step 2
extern ETipoPiramidazione tipoPiramidazione3 = EPiramidazioneNessuna; // Select the type of Pyramidation
extern int numeroPiramidazioneStep3; // Number of Pyramidations for Step 3
extern int pointsDistanzaPiramidazioneStep3; // Points Distance pyramiding Step 3
extern ETipoPiramidazione tipoPiramidazione4 = EPiramidazioneNessuna; // Select the type of Pyramidation
extern int numeroPiramidazioneStep4; // Number of Pyramidations for Step 4
extern int pointsDistanzaPiramidazioneStep4; // Points Distance pyramiding Step 4
extern ETipoIncrementoSize tipoIncrementoSize = ENessuno; // Select the type of size increment
extern double valoreIncremento = 0.01; // Increment value
extern string listaSpreadDaNonTradare1; // List of spreads not to be traded (! for the instrument, for spreads on
extern string listaSpreadDaNonTradare2; // List of spreads not to be traded (! for the instrument, for spreads on
extern string listaSpreadDaNonTradare3; // List of spreads not to be traded (! for the instrument, for spreads on
extern bool nonTradareCoppieCorrelate; // Do not trade related pairs (with the same numerator or same de
extern bool tradareSoloCoppieCorrelate; // Trade related pairs ONLY (With the same numerator or same den
extern string listaSpreadDaTradare1; // List of additional spreads to trade (! for the instrument, for sp
extern string eaOper2 = "------------------ Panel Settings -------------------"; // <>
extern bool richiediConfermaInserimentoOperazioni = true; // Request confirmation of opening operations
extern int grandezzaFont = 8; // Font Size
extern int deltaXIniziale; // Delta X Initial
extern int deltaYIniziale; // Initial Delta Y
extern double moltiplicatoreGrafiche = 1.2; // Graphics Multiplier
extern string nomeTemplate = "PulseMatrixNuovo.tpl"; // Template file name
extern string exEA1 = "<---------- Alarms ---------->"; // <>
extern string exEA2; // <--- Alarms due to Errors --->
extern bool utilizzaAllarmiErrore = true; // EA alerts for errors
extern bool utilizzaAlertErrore = true; // Use Alarm for errors
extern bool utilizzaPopupErrore = true; // Use Push Notifications for errors
extern bool utilizzaMailErrore = true; // Use Send Mail for errors
extern string exEA3; // <--- Alarms for Order Entry --->
extern bool utilizzaAllarmiInserimentoOrdini = true; // EA alarms for order entry
extern bool utilizzaAlertInserimentoOrdini = true; // Use Alarm for order entry
extern bool utilizzaPopupInserimentoOrdini = true; // Use Push Notifications for placing orders
extern bool utilizzaMailInserimentoOrdini = true; // Use Send Mail to enter orders
extern string exEA4; // <--- Alarms for Change Orders (Stoploss & Takeprofit)--->
extern bool utilizzaAllarmiModificaOrdini = true; // EA alarms for order changes
extern bool utilizzaAlertModificaOrdini = true; // Use Alarm to change orders
extern bool utilizzaPopupModificaOrdini = true; // Use Push Notifications for order changes
extern bool utilizzaMailModificaOrdini = true; // Use Send Mail to modify orders
...
void func_1051(int Fa_i_00, string Fa_s_01, string Fa_s_02, string Fa_s_03, string Fa_s_04)
  {
   ...
   if(utilizzaAllarmiInserimentoOrdini == false)
      return;
   ...
   if(utilizzaMailInserimentoOrdini == false)
      return;
...
void func_1052(int Fa_i_00, string Fa_s_01, string Fa_s_02, string Fa_s_03, string Fa_s_04)
  {
   ...
   if(utilizzaAllarmiModificaOrdini == false)
      return;
   tmp_str00001 = Fa_s_03 + " ";
   tmp_str00001 = tmp_str00001 + Is_09CA0;
   tmp_str00001 = tmp_str00001 + " ";
...
void func_1058()
  {
   ...
   Li_FFFD8 = MagicInp;
   Li_FFFD4 = 0;
   if(Li_FFFD4 >= ArraySize(Is_09CB0))
      return;
   do
     {
      Li_FFFD0 = 0;
                           ...
                           if(Li_FFF60 >= Gi_00021 && (Ld_FFF40 != 0) && (Ld_FFF48 != 0) && (Ld_FFF48 != 2147483647))
                             {
                              ...
                              if(Li_FFFD0 >= ArraySize(Input_Struct_00009CE4))
                                 return;
                        ...
                        && (Local_Struct_FFFFFEDC[Li_FFEC4].m_48 >= valorePuntiOverlayPerIngresso))
                       {
                        ...
                        if(utilizzaFiltroCorrelazionePerIngresso == false
                           ...
                           || (valoreCorrelazioneNegativaPerIngesso != 0 && Local_Struct_FFFFFEDC[Li_FFEC4].m_56 <= Gd_0009C))
                          {
                           ...
                           if(ArraySize(Input_Struct_00009D18) >= numeroMassimoCoppieOperative)
                              break;
...
bool func_1073()
  {
            ...
            if(Gi_00001 < Gi_00002)
              {
               ...
               if(tmp_str00002 != TimeToString(TimeCurrent(), 1))
                  break;
   ...
   if(((Ld_FFFE0 + Ld_FFFF0) < massimoGainGiornaliero))
      return false;
...
void func_1076(int Fa_i_00, string Fa_s_01, string Fa_s_02)
  {
   ...
   if(Il_1CF14[Fa_i_00] == iTime(Fa_s_01, 0, 0))
      return;
   Li_FFFE8 = 0;
   Li_FFFE4 = 0;
            ...
            if(OrderSymbol() == Fa_s_00 || OrderSymbol() == Fa_s_01)
              {
               ...
               if(tmp_str00000 != TimeToString(TimeCurrent(), 1))
                  break;
               if(OrderSymbol() == Fa_s_00)
                 {
   ...
   if(func_1078(tmp_str00000) != true)
     {
      ...
      if(!func_1078(tmp_str00001))
         return;
     }
   Gl_00000 = iTime(Fa_s_03, 0, 0);
   if(Gl_00000 != iTime(Fa_s_04, 0, 0))
      return;
   if(calcolaLottiAutomaticamente != true)
     {
      Gd_00000 = lottiBase;
   ...
   if(numeroMassimoOperazioniInGain != 0)
     {
      ...
      if(!func_1080(tmp_str00009, tmp_str00007))
         return;
     }
...
void func_1096(int Fa_i_00, string Fa_s_01, string Fa_s_02, double Fa_d_03)
  {
   ...
   if((Id_0A714[Fa_i_00] == 0))
      return;
   if((Ld_FFFF0 > Id_0A714[Fa_i_00]))
      return;
...
void func_1097(Coppia &FuncArg_Struct_00000000, string Fa_s_01, string Fa_s_02)
  {
   ...
   if(utilizzaChiusuraSuValoreOverlay == false)
      return;
   tmp_str00001 = "LS";
   ...
   if(!func_1041(tmp_str00010, tmp_str0000E, Ii_1D234, tmp_str0000F))
      return;
   tmp_str00013 = "SS";
   ...
   if(tipoChiusuraOverlay == 2
      ...
      || (tipoChiusuraOverlay == 1 && Ld_FFFF0 < 0))
     {
      ...
      if((FuncArg_Struct_00000000.m_40 == 0))
         return;
      if((FuncArg_Struct_00000000.m_40 > valoreOverlayPerChiusura))
         return;
